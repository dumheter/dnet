...
template<typename TTransport = Tcp,
         typename THeader = Packet_header,
...
template<typename TTransport, typename TPacket, u64 MAX_PAYLOAD_SIZE>
void
Connection<TTransport, TPacket, MAX_PAYLOAD_SIZE>::connect(
  const std::string& ip,
  u16 port)
{
...
void
Connection<TTransport, THeader, MAX_PAYLOAD_SIZE>::disconnect()
{
...
template<typename TTransport, typename THeader, u64 MAX_PAYLOAD_SIZE>
void
Connection<TTransport, THeader, MAX_PAYLOAD_SIZE>::write(
...
template<typename TTransport, typename THeader, u64 MAX_PAYLOAD_SIZE>
void
Connection<TTransport, THeader, MAX_PAYLOAD_SIZE>::write(const u8* payload,
                                                         size_t payload_size)
{
  // todo make it possible to break out of loops if bad header
...
template<typename TTransport, typename TPacket, u64 MAX_PAYLOAD_SIZE>
bool
Connection<TTransport, TPacket, MAX_PAYLOAD_SIZE>::can_read() const
{
...
template<typename TTransport, typename TPacket, u64 MAX_PAYLOAD_SIZE>
bool
Connection<TTransport, TPacket, MAX_PAYLOAD_SIZE>::can_write() const
{
...
template<typename TTransport, typename TPacket, u64 MAX_PAYLOAD_SIZE>
bool
Connection<TTransport, TPacket, MAX_PAYLOAD_SIZE>::can_accept() const
{
...
template<typename TTransport, typename TPacket, u64 MAX_PAYLOAD_SIZE>
bool
Connection<TTransport, TPacket, MAX_PAYLOAD_SIZE>::has_error() const
{
...
template<typename TTransport, typename TPacket, u64 MAX_PAYLOAD_SIZE>
void
Connection<TTransport, TPacket, MAX_PAYLOAD_SIZE>::start_server(u16 port)
{
